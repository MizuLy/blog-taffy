...
const APIPassword = `http://localhost:8880/api/auth/password`;
export default function Account() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.put(APIPassword, formData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  return (
    <div>
      ...
      <h1 className="text-xl font-semibold flex items-center gap-2 mb-4">
        <MdOutlineAccountCircle size={20} /> Password
      </h1>

      {/* Content */}
      <div className="">
        <h2 className="text-lg font-medium mb-4">
          See information about your password.
        </h2>
